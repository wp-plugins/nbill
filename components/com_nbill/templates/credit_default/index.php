<?php
/*
You can create your own credit note template based on this one, but if you want to
...
(bear in mind that this file is included once for each credit note).
...
the file default_template_credit_line_item.php).
*/
...
<div class="document-container" style="<?php echo $style_container; ?>">
    ...
    <table class="billing-details" style="<?php echo $style_billing_details; ?>">
        <tr>
            ...
            <td class="vendor" style="<?php echo $style_vendor; ?>">
                <h1 style="<?php echo $style_title; ?>"><?php echo nbf_common::parse_translation($document->default_language, "template.cr", 'NBILL_PRT_CREDIT_TITLE'); ?></h1>
        ...
        <tr>
            ...
            <td>
                <table cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        <td style="<?php echo $style_document_details_td; ?>"><?php echo nbf_common::parse_translation($document->default_language, "template.cr", 'NBILL_PRT_CREDIT_NO'); ?>&nbsp;</td>
                    ...
                    <?php if (nbf_common::nb_strlen($document->tax_no) > 0) { ?>
                    <tr>
    ...
    $line_item_view = new nBillDefaultTemplateCreditLineItem($line_items[$document->id], $document);
            ...
            <td style="text-align:right;padding-right:0px;">
                <table cellpadding="3" cellspacing="0" border="0" style="text-align:right;">
                    ...
                    <tr style="<?php echo $style_shaded_row; ?>">
                        <td style="<?php echo $no_summary ? $style_total_td_numeric_top_left : $style_total_td_numeric_left; ?>"><?php echo nbf_common::parse_translation($document->default_language, "template.cr", 'NBILL_PRT_AMOUNT_REFUNDED'); ?> </td>
    ...
    if ($document->paid_in_full || $document->partial_payment)
    {
        if (count($payment_details[$document->id]) > 0)
        {
            ...
            <table cellpadding="3" cellspacing="0" border="0" style="margin-top:10px;width:100%;">
                <tr>
                    <td colspan="4"><strong><?php echo nbf_common::parse_translation($document->default_language, "template.cr", 'NBILL_PAYMENT_SENT'); ?></strong></td>
                </tr>
                <tr>
                    <th class="main_headings" style="<?php echo $style_th_left; ?>"><?php echo nbf_common::parse_translation($document->default_language, "template.cr", 'NBILL_CR_PAYMENT_DATE'); ?></th>
                    <th class="main_headings" style="<?php echo $style_th; ?>"><?php echo nbf_common::parse_translation($document->default_language, "template.cr", 'NBILL_CR_PAYMENT_METHOD'); ?></th>
                    <th class="main_headings" style="<?php echo $style_th; ?>"><?php echo nbf_common::parse_translation($document->default_language, "template.cr", 'NBILL_CR_PAYMENT_REFERENCE'); ?></th>
                    <th class="main_headings" style="<?php echo $style_th_numeric; ?>"><?php echo nbf_common::parse_translation($document->default_language, "template.cr", 'NBILL_CR_PAYMENT_AMOUNT'); ?></th>
                </tr>
                <?php
                ...
                foreach ($payment_details[$document->id] as $payment_detail)
                {
                    ...
                    <tr style="<?php echo !$pdf && $row == 1 ? $style_shaded_row : ''; ?>">
                        ...
                        <td style="<?php echo $style_td; ?>"><?php echo nbf_common::nb_strlen($payment_detail->transaction_no) > 0 ? $payment_detail->transaction_no : nbf_common::parse_translation($document->default_language, "template.cr", 'NBILL_CR_REFERENCE_UNKNOWN'); ?></td>
                ...
                $outstanding->value = $outstanding->value < 0 ? 0 : $outstanding->value;
                ?>
                <tr>
                    <td colspan="3" style="<?php echo $style_total_td; ?>"><?php echo nbf_common::parse_translation($document->default_language, "template.cr", 'NBILL_CR_TOTAL_PAID'); ?></td>
            ...
            <table cellpadding="3" cellspacing="0" border="0" style="margin-top:10px;width:100%">
                <tr>
                    ...
                    <td style="text-align:right;padding-right:0px;">
                        <table cellpadding="3" cellspacing="0" border="0" style="text-align:right;">
                            <tr style="<?php echo $style_shaded_row; ?>">
                                <td style="<?php echo $style_total_td_numeric_top_left; ?>"><?php echo nbf_common::parse_translation($document->default_language, "template.cr", 'NBILL_CR_TOTAL_DUE'); ?></td>
                                <td style="<?php echo $style_total_td_numeric_top; ?>"><?php echo $outstanding; ?></td>
                            </tr>
                        </table>
                    </td>
                </tr>
        ...
        {
            ?><p><strong><?php echo nbf_common::parse_translation($document->default_language, "template.cr", 'NBILL_FULL_PAYMENT_SENT'); ?></strong></p><?php
        }
    }
