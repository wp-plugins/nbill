...
<title><?php echo nbf_common::parse_translation($document->default_language, "email", 'NBILL_EM_NEW_CREDIT'); ?></title>
<style type="text/css">
body, td
{
...
<body>
    <table cellpadding="3" cellspacing="0" border="0">
        <tr>
            ...
            <th align="left"><h3><?php echo nbf_cms::$interop->site_name; ?> - <?php echo nbf_common::parse_translation($document->default_language, "email", 'NBILL_EM_NEW_CREDIT'); ?></h3></th>
        </tr>
        <tr>
            <td align="left" colspan="2">
                <p><?php echo sprintf(nbf_common::parse_translation($document->default_language, "email", 'NBILL_EM_GREETING'), $contact_name); ?></p>
                <p><?php echo nbf_common::parse_translation($document->default_language, "email", 'NBILL_EM_NEW_CREDIT_PAR_1_ATTACHED'); ?></p>
                <p><?php echo sprintf(nbf_common::parse_translation($document->default_language, "email", 'NBILL_EM_NEW_CREDIT_PAR_2'), nbf_cms::$interop->live_site); ?></p>
