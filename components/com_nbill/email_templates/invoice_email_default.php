    ...
    <table cellpadding="3" cellspacing="0" border="0">
        ...
        <tr>
            <td align="left" colspan="2">
                ...
                <p><?php echo nbf_common::parse_translation($document->default_language, "email", 'NBILL_EM_NEW_INVOICE_PAR_1'); ?></p>
                <p><?php @$document->username ? sprintf(nbf_common::parse_translation($document->default_language, "email", 'NBILL_EM_NEW_INVOICE_PAR_2_USERNAME'), '<a href="' . nbf_cms::$interop->live_site . '">' . nbf_cms::$interop->live_site . '</a>', $document->username) : sprintf(nbf_common::parse_translation($document->default_language, "email", 'NBILL_EM_NEW_INVOICE_PAR_2'), '<a href="' . nbf_cms::$interop->live_site . '">' . nbf_cms::$interop->live_site . '</a>'); ?></p>
