...
<html>
    <head>
        ...
        <title><?php echo NBILL_INCOME_RECEIPT_TITLE; ?></title>
        ...
        table.nbill-receipt-table
        {
            border-collapse: collapse;
        }
        .nbill-receipt-table td, .nbill-receipt-table th
        {
    ...
    <table cellpadding="10" cellspacing="0" border="0" width="100%">
        <tr>
            ...
            <td valign="middle" class="vendor" style="text-align:right">
                ...
                <h1><?php echo NBILL_INCOME_RECEIPT_TITLE; ?></h1>
            </td>
        </tr>
    </table>

    <p><?php echo NBILL_INCOME_RECEIPT_INTRO; ?></p>
    <table cellpadding="0" cellspacing="3" border="0" class="nbill-receipt-table" width="100%">
        <tr>
            <th style="width:150px;"><?php echo NBILL_INCOME_DATE; ?></th>
            <td><?php echo nbf_common::nb_date(nbf_common::get_date_format(), $row->date); ?></td>
        </tr>
        <tr>
            <th><?php echo NBILL_RECEIVED_FROM; ?></th>
            <td><?php echo $row->name; ?></td>
        </tr>
        <tr>
            <th><?php echo NBILL_PAYMENT_METHOD; ?></th>
            <td><?php
            echo $row->pay_method_name; ?></td>
        </tr>
        <tr>
            <th><?php echo NBILL_INCOME_RECEIPT_NO; ?></th>
            <td><?php echo $row->transaction_no ? $row->transaction_no : NBILL_RECEIPT_NOT_YET_ASSIGNED; ?></td>
        </tr>
        <tr>
            <th><?php echo NBILL_AMOUNT_RECEIVED; ?></th>
    ...
    <?php if (count($documents) > 0)
    {
        ...
        {
            $invoice_list[] = sprintf(NBILL_INCOME_RE_INVOICE, $document->document_no, nbf_common::nb_date(nbf_common::get_date_format(), $document->document_date));
        }
        ?>
        <br />
        <table cellpadding="3" cellspacing="0" border="0">
            <tr>
                <td style="vertical-align:top">
                    <?php echo NBILL_INCOME_RE_INVOICES; ?>
                </td>
                <td style="vertical-align:top">
    ...
    <?php } ?>
    <p><?php echo NBILL_INCOME_THANKS; ?></p>
    </body>
</html>